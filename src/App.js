...
function App() {
     ...
     const getLectureAEC301 = async  () => {
      axios.get("https://crazy-plum-cloak.cyclic.app/api/aec301/")
      .then(res => {
     ...
     const getLectureAEC303 = async  () => {
      axios.get("https://crazy-plum-cloak.cyclic.app/api/aec303/")
      .then(res => {
        console.log(res.data)
     ...
     const getLectureANS301 = async  () => {
      axios.get("https://crazy-plum-cloak.cyclic.app/api/ans301/")
      .then(res => {
        console.log(res.data)
     ...
     const getLectureAXD301 = async  () => {
      axios.get("https://crazy-plum-cloak.cyclic.app/api/axd301/")
      .then(res => {
        console.log(res.data)
     ...
     const getLectureCPP301 = async  () => {
      axios.get("https://crazy-plum-cloak.cyclic.app/api/cpp301/")
      .then(res => {
        console.log(res.data)
     ...
     const getLectureCPP303 = async  () => {
      axios.get("https://crazy-plum-cloak.cyclic.app/api/cpp303/")
      .then(res => {
        console.log(res.data)
     ...
     const getLectureSLM301 = async  () => {
        axios.get("https://crazy-plum-cloak.cyclic.app/api/slm301/")
        .then(res => {
          console.log(res.data)
