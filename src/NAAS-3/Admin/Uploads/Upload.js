...
import image4 from "../Images/extension.jpg"
...
function ViewHome (props) {
    ...
    useEffect(()=> {
       ...
       return (
          ...
          <h1 className="text-center font-bold font-montserat text-white bg-gradient-to-r from-[#182c25] to-[#1e453e]" data-aos="fade-left"> Upload Lectures</h1>
                    {
                        ViewList.map((info,i) => (
